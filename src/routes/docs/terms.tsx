        ...
        <CardContent className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            ...
            <p className="opacity-80 ml-4">
              Our platform connects buyers (Demand Side) with suppliers and
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            ...
            <p className="opacity-80 ml-4">
              ...
              You are responsible for maintaining account security. One account
              per user or business entity.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            <h1>5. Contact Information Exchange</h1>
            <p className="opacity-80 ml-4">
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            ...
            <p className="opacity-80 ml-4">
              Provide accurate, honest information in all posts. Conduct
              business dealings ethically and legally. Do not spam, harass, or
              misuse the platform. Negotiate deals directly with matched
              parties.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            ...
            <p className="opacity-80 ml-4">
              ...
              do not guarantee accuracy of matches or successful deals. Platform
              does not endorse any specific user or offering.
            </p>
          </div>

          <div className="flex flex-col gap-2 border-b pb-4">
            <h1>8. Platform Role</h1>
            <p className="opacity-80 ml-4">
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            <h1>10. Liability</h1>
            <p className="opacity-80 ml-4">
              Platform provided "as is" without warranties. We are not liable
          ...
          <div className="flex flex-col gap-2 border-b pb-4">
            ...
            <p className="opacity-80 ml-4">
              We may suspend or terminate accounts for Terms violations. Users
              may close accounts at any time. No refunds upon termination.
            </p>
          </div>
